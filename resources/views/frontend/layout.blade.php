...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('themes/ezone/assets/img/logo.jpg') }}">
            ...
            <div class="container-fluid">
                <div class="header-bottom-wrapper">
                    <div class="logo-2 furniture-logo ptb-30">
                        <a href="/">
                            <img src="{{ asset('themes/ezone/assets/img/logo/hehe.png') }}" alt="">
                        </a>
                    </div>
            ...
            <div class="container-fluid">
                <div class="widget-wrapper">
                    <div class="footer-widget mb-30">
                        <a href="#"><img src="{{ asset('themes/ezone/assets/img/logo/hehe.png') }}"
                                alt=""></a>
                        <div class="footer-about-2">
                            <p>*Sensasi Manies* – Surga Camilan Manis & Gurih!

                                Selamat datang di Sensasi Manies, tempat di mana cita rasa unik dan tekstur lezat
                                berpadu dalam setiap gigitan! Kami menghadirkan inovasi dari olahan ubi dengan menu
                                spesial seperti *Bola-Bola Ubi* (original & mozzarella) yang tersedia dalam varian rasa
                                Matcha, Stroberi, Tiramisu, dan Coklat. Tak hanya itu, kami juga menawarkan *Ubi Tarik*,
                                kombinasi sempurna antara ubi lembut dan keju mozzarella yang meleleh, dibalut dalam
                                roti renyah.
                                Nikmati sensasi manis dan gurih yang menggoda selera hanya di <br>*Sensasi Manies*! 🍠🧀
                            </p>
                        </div>
                    </div>
                    <div class="footer-widget mb-30">
                        ...
                        <div class="footer-info-wrapper-3">
                            ...
                            <div class="footer-address-furniture">
                                ...
                                <div class="footer-info-content3">
                                    <p><a href="#">virkifadrian@gmail.com</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
